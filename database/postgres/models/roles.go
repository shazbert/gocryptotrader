...
func (o *Role) ClientRoles(mods ...qm.QueryMod) clientRoleQuery {
	...
	queryMods = append(queryMods,
		qm.Where("\"client_roles\".\"role_id\"=?", o.ID),
	)
...
func (o *Role) RoleKeys(mods ...qm.QueryMod) roleKeyQuery {
	var queryMods []qm.QueryMod
	if len(mods) != 0 {
		queryMods = append(queryMods, mods...)
	}
	...
	queryMods = append(queryMods,
		qm.Where("\"role_keys\".\"role_id\"=?", o.ID),
	)
...
func (roleL) LoadClientRoles(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(qm.From(`client_roles`), qm.WhereIn(`role_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
// loaded structs of the objects. This is for a 1-M or N-M relationship.
func (roleL) LoadRoleKeys(ctx context.Context, e boil.ContextExecutor, singular bool, maybeRole interface{}, mods queries.Applicator) error {
	var slice []*Role
	var object *Role
	...
	query := NewQuery(qm.From(`role_keys`), qm.WhereIn(`role_id in ?`, args...))
	if mods != nil {
		mods.Apply(query)
	}
...
func (o *Role) AddClientRoles(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*ClientRole) error {
	var err error
...
// Sets related.R.Role appropriately.
func (o *Role) AddRoleKeys(ctx context.Context, exec boil.ContextExecutor, insert bool, related ...*RoleKey) error {
	var err error
	for _, rel := range related {
		if insert {
			rel.RoleID = o.ID
