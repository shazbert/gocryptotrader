...
func (o *ORM) GetFullPlatformHistory(exchName, currencyPair, assetType string) ([]exchange.PlatformTrade, error) {
	o.Lock()
	defer o.Unlock()

	h, err := models.ExchangeTradeHistories(
