...
<img src="/backtester/common/backtester.png?raw=true" alt="GoCryptoTrader backtester logo" width="350px" height="350px" hspace="70">
...
This outputs a file named `plugins.so` which can be loaded by the backtester. At present, only custom strategies can be loaded. See the [custom strategy plugin example](/strategies/example/README.md) for more information.
