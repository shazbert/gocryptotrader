...
// intial operations
func (p *Poloniex) GetPlatformHistory(cp pair.CurrencyPair, assetType string, timestampStart time.Time, tradeID string) ([]exchange.PlatformTrade, error) {
	...
	t, err := p.GetTradeHistory(cp.Pair().String(),
