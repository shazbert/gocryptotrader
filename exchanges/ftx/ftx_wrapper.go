...
func (f *FTX) UpdateAccountInfo() (account.FullSnapshot, error) {
	...
	err = f.LoadHoldings(account.Default, asset.Spot, m)
	if err != nil {
		return nil, err
	}
	return f.GetFullSnapshot()
}

// FetchAccountInfo retrieves balances for all enabled currencies
func (f *FTX) FetchAccountInfo() (account.FullSnapshot, error) {
	acc, err := f.GetFullSnapshot()
	if err != nil {
...
func (f *FTX) GetDepositAddress(cryptocurrency currency.Code, _ string) (exchange.DepositAddress, error) {
