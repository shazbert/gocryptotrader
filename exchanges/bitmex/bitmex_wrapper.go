...
// Bitmex exchange
func (b *Bitmex) UpdateAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
...
func (b *Bitmex) FetchAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
