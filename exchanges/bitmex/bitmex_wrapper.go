...
func (b *Bitmex) SetDefaults() {
	...
	b.Features = &protocol.Features{
		...
		Websocket: &protocol.Components{
			...
			AuthenticatedEndpoints: protocol.SetNewComponentNoRate(true, false),
			AccountInfo:            protocol.SetNewComponentNoRate(true, true),
			DeadMansSwitch:         protocol.SetNewComponentNoRate(true, false),
		},
	}
...
func (b *Bitmex) GetExchangeHistory(p *exchange.TradeHistoryRequest) ([]exchange.TradeHistory, error) {
	return nil, common.ErrNotYetImplemented
}
