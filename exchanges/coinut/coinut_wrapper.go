...
func (c *COINUT) SetDefaults() {
	...
	c.Features = &protocol.Features{
		...
		Websocket: &protocol.Components{
			...
			SubmitOrder:            protocol.SetNewComponentNoRate(true, true),
			SubmitOrders:           protocol.SetNewComponentNoRate(true, true),
			CancelOrder:            protocol.SetNewComponentNoRate(true, true),
...
func (c *COINUT) GetExchangeHistory(p *exchange.TradeHistoryRequest) ([]exchange.TradeHistory, error) {
