...
func (ok *Okx) WsPlaceOrder(ctx context.Context, arg *PlaceOrderRequestParam) (*OrderData, error) {
	...
	err = ok.SendWebsocketRequest(ctx, id, "order", []PlaceOrderRequestParam{*arg}, &orderResp)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) WsPlaceMultipleOrder(ctx context.Context, args []PlaceOrderRequestParam) ([]OrderData, error) {
	...
	var orderResp []OrderData
	return orderResp, ok.SendWebsocketRequest(ctx, id, "batch-orders", args, &orderResp)
}
...
func (ok *Okx) WsCancelOrder(ctx context.Context, arg CancelOrderRequestParam) (*OrderData, error) {
	...
	var orderResp []OrderData
	err := ok.SendWebsocketRequest(ctx, id, "cancel-order", []CancelOrderRequestParam{arg}, &orderResp)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) WsCancelMultipleOrder(ctx context.Context, args []CancelOrderRequestParam) ([]OrderData, error) {
	...
	// may not. So return everything to the caller to handle.
	var orderResp []OrderData
	return orderResp, ok.SendWebsocketRequest(ctx, id, "batch-cancel-orders", args, &orderResp)
}
...
func (ok *Okx) WsAmendOrder(ctx context.Context, arg *AmendOrderRequestParams) (*OrderData, error) {
	...
	var orderResp []OrderData
	err := ok.SendWebsocketRequest(ctx, id, "amend-order", []AmendOrderRequestParams{*arg}, &orderResp)
	if err != nil {
		return nil, err
	}
...
func (ok *Okx) WsAmendMultipleOrders(ctx context.Context, args []AmendOrderRequestParams) ([]OrderData, error) {
	...
	// may not. So return everything to the caller to handle.
	var orderResp []OrderData
	return orderResp, ok.SendWebsocketRequest(ctx, id, "batch-amend-orders", args, &orderResp)
}

// SendWebsocketRequest sends a websocket request to the server
func (ok *Okx) SendWebsocketRequest(ctx context.Context, id, operation string, payload, response any) error {
