...
func (e *Exchange) PlaceOrder(ctx context.Context, arg *PlaceOrderRequestParam) (*OrderData, error) {
	...
	ctx = request.WithRateLimits(ctx, requestScopedRateLimits...)
	var resp *OrderData
	if err := e.SendHTTPRequest(ctx, exchange.RestSpot, placeOrderEPL, http.MethodPost, "trade/order", &arg, &resp, request.AuthenticatedRequest); err != nil {
...
func (e *Exchange) PlaceMultipleOrders(ctx context.Context, args []PlaceOrderRequestParam) ([]OrderData, error) {
	...
	ctx = request.WithRateLimits(ctx, requestScopedRateLimits...)
	var resp []OrderData
	if err := e.sendHTTPRequestWithRateLimitWeight(ctx, exchange.RestSpot, placeMultipleOrdersEPL, batchWeight, http.MethodPost, "trade/batch-orders", &args, &resp, request.AuthenticatedRequest); err != nil {
		if len(resp) == 0 {
			return nil, err
		}
		var errs error
...
func (e *Exchange) CancelSingleOrder(ctx context.Context, arg *CancelOrderRequestParam) (*OrderData, error) {
	...
	ctx = request.WithRateLimits(ctx, requestScopedRateLimits...)
	var resp *OrderData
	if err := e.SendHTTPRequest(ctx, exchange.RestSpot, cancelOrderEPL, http.MethodPost, "trade/cancel-order", &arg, &resp, request.AuthenticatedRequest); err != nil {
		if resp != nil && resp.StatusMessage != "" {
			return nil, fmt.Errorf("%w; %w", err, getStatusError(resp.StatusCode, resp.StatusMessage))
		}
		return nil, err
...
func (e *Exchange) CancelMultipleOrders(ctx context.Context, args []CancelOrderRequestParam) ([]*OrderData, error) {
	...
	ctx = request.WithRateLimits(ctx, requestScopedRateLimits...)
	var resp []*OrderData
	if err := e.sendHTTPRequestWithRateLimitWeight(ctx, exchange.RestSpot, cancelMultipleOrdersEPL, batchWeight, http.MethodPost, "trade/cancel-batch-orders", args, &resp, request.AuthenticatedRequest); err != nil {
		if len(resp) == 0 {
			return nil, err
		}
		var errs error
...
func (e *Exchange) AmendMultipleOrders(ctx context.Context, args []AmendOrderRequestParams) ([]OrderData, error) {
	...
	ctx = request.WithRateLimits(ctx, requestScopedRateLimits...)
	var resp []OrderData
	return resp, e.sendHTTPRequestWithRateLimitWeight(ctx, exchange.RestSpot, amendMultipleOrdersEPL, batchWeight, http.MethodPost, "trade/amend-batch-orders", &args, &resp, request.AuthenticatedRequest)
}
