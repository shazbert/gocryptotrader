...
func TestRetrieve(t *testing.T) {
	...
	assert.Equal(t, d.options.reachedCodeAt, ob.ReachedCodeAt, "Should have correct ReachedCodeAt")
	assert.Equal(t, d.options.checksumDoneAt, ob.ChecksumDoneAt, "Should have correct ChecksumDoneAt")
