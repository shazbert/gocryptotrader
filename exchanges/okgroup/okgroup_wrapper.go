...
func (o *OKGroup) UpdateAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
...
func (o *OKGroup) FetchAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
