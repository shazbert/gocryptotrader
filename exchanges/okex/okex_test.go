...
// CheckCanManipulateOrders Sets test defaults when test can impact real money/orders
func CheckCanManipulateOrders(t *testing.T) {
...
func TestMain(m *testing.M) {
	...
	if o.GetName() != OKGroupExchange {
		log.Printf("%v - SetDefaults() error", OKGroupExchange)
	}

	if o.API.Credentials.Key == apiKey &&
		o.API.Credentials.Secret == apiSecret &&
		o.API.Credentials.ClientID == passphrase &&
		apiKey != "" &&
		apiSecret != "" &&
		passphrase != "" {
		return
	...
	genericFutureInstrumentID, err = getFutureInstrumentID()
	if err != nil {
		log.Println(err)
	}
	os.Exit(m.Run())
...
func getFutureInstrumentID() (string, error) {
	if genericFutureInstrumentID != "" {
		return genericFutureInstrumentID, nil
	}
...
func TestGetFuturesPostionsForCurrency(t *testing.T) {
	_, err := o.GetFuturesPostionsForCurrency(genericFutureInstrumentID)
	testStandardErrorHandling(t, err)
}
...
func TestSetFuturesLeverage(t *testing.T) {
	...
	request := okgroup.SetFuturesLeverageRequest{
		Currency:     currency.BTC.String(),
		InstrumentID: genericFutureInstrumentID,
		Leverage:     10,
		Direction:    "Long",
	}
...
func TestGetFuturesTokenInfoForCurrency(t *testing.T) {
	id, err := getFutureInstrumentID()
	if err != nil {
		t.Fatal(err)
	}
	_, err = o.GetFuturesTokenInfoForCurrency(id)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetFuturesHoldAmount(t *testing.T) {
	...
	_, err = o.GetFuturesHoldAmount(id)
	testStandardErrorHandling(t, err)
}
...
func TestGetFuturesEstimatedDeliveryPrice(t *testing.T) {
	t.Parallel()
	_, err := o.GetFuturesEstimatedDeliveryPrice(genericFutureInstrumentID)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetFuturesOpenInterests(t *testing.T) {
	t.Parallel()
	_, err := o.GetFuturesOpenInterests(genericFutureInstrumentID)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetFuturesCurrentPriceLimit(t *testing.T) {
	t.Parallel()
	_, err := o.GetFuturesCurrentPriceLimit(genericFutureInstrumentID)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetFuturesCurrentMarkPrice(t *testing.T) {
	t.Parallel()
	_, err := o.GetFuturesCurrentMarkPrice(genericFutureInstrumentID)
	if err != nil {
		t.Error(err)
	}
}
...
func TestGetFuturesTagPrice(t *testing.T) {
	t.Parallel()
	_, err := o.GetFuturesTagPrice(genericFutureInstrumentID)
	testStandardErrorHandling(t, err)
}
