...
// intial operations
func (b *Bithumb) GetPlatformHistory(p pair.CurrencyPair, assetType string, timestampStart time.Time, tradeID string) ([]exchange.PlatformTrade, error) {
	...
	t, err := b.GetTransactionHistory(p.FirstCurrency.String(), ID)
	if err != nil {
		return resp, err
	}
