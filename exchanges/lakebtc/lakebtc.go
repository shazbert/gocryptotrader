...
func (l *LakeBTC) GetTradeHistory(currencyPair string, tsStart int64) ([]TradeHistory, error) {
	v := url.Values{}
	v.Set("symbol", strings.ToLower(currencyPair))
	if tsStart != 0 {
		v.Set("at", strconv.FormatInt(tsStart, 10))
	}
