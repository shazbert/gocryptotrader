...
func (l *LakeBTC) GetExchangeHistory(p *exchange.TradeHistoryRequest) ([]exchange.TradeHistory, error) {
	var resp []exchange.TradeHistory
	fPair := l.FormatExchangeCurrency(p.Pair, p.Asset)
	t, err := l.GetTradeHistory(fPair.String(), p.TimestampStart.Unix())
	if err != nil {
		return resp, err
	}
