...
func (e *EXMO) GetExchangeHistory(p *exchange.TradeHistoryRequest) ([]exchange.TradeHistory, error) {
	var resp []exchange.TradeHistory
	tradesMap, err := e.GetTrades(e.FormatExchangeCurrency(p.Pair, p.Asset).String())
	if err != nil {
		return resp, err
	}
