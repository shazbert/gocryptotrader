...
// Bitfinex exchange
func (b *Bitfinex) UpdateAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
...
func (b *Bitfinex) FetchAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
