...
// Alphapoint exchange
func (a *Alphapoint) UpdateAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
...
// Alphapoint exchange
func (a *Alphapoint) FetchAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
