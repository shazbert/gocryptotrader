...
// Bittrex exchange
func (b *Bittrex) UpdateAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
...
func (b *Bittrex) FetchAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
