...
func (b *Bittrex) GetExchangeHistory(p *exchange.TradeHistoryRequest) ([]exchange.TradeHistory, error) {
	var resp []exchange.TradeHistory
	trades, err := b.GetMarketHistory(b.FormatExchangeCurrency(p.Pair, p.Asset).String())
	if err != nil {
		return resp, err
	}
