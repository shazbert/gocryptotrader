...
func (i *ItBit) UpdateAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
...
func (i *ItBit) FetchAccountInfo(accountName string, assetType asset.Item) (*account.Holdings, error) {
